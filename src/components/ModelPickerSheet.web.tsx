...
// Web fallback for the model picker. Same catalog + search as the native bottom
// sheet, shown in a plain modal overlay so it works in every browser.
    ...
    return (
      <Modal visible={visible} transparent animationType="slide" onRequestClose={close}>
        <View style={styles.overlay}>
          <Pressable style={styles.backdrop} onPress={close} accessibilityLabel="Tutup" />
